...
CREATE TABLE `sys_menu` (
  ...
  `show_menu` tinyint unsigned DEFAULT '1' COMMENT '前端是否显示菜单,1-显示,0-隐藏',
...
-- ----------------------------
BEGIN;
INSERT INTO `sys_menu` VALUES (1, 0, '首页', 1, '/', '', 'dashboard', 'Layout', '/dashboard', 1, 1, '2020-10-22 14:41:11', '2022-10-03 16:31:54');
